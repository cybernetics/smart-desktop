...
// Animation a1 = BasicTextAnimation.defaultFade(label, 10000, "Welcome To",
//// Color.orange);
//
// Animation a2 = BasicTextAnimation.defaultScale(label, 10000, "The JGoodies",
//// Color.cyan);
//
// Animation a3 = BasicTextAnimation.defaultSpace(label, 10000, "Animation
//// Demonstration!", Color.magenta);
//
// Animation allSeq = Animations.sequential(new Animation[] {
//// Animations.pause(1000), a1, Animations.pause(1000), a2,
