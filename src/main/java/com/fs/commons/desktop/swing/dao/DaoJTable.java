...
//
//	public DaoJTable(DataPanel dataPanel ,String sql,boolean showIdColunm,boolean autoIncrement) {
...
//	 * @param autoIncrement
//	 */
//	public DaoJTable(QueryTableModel model, DataPanel dataPanel, boolean autoIncrement) {
...
//	 *            boolean
//	 */
//	public DaoJTable(Dialog parent, QueryTableModel model, DataPanel dataPanel, boolean autoIncrement) {
//		this.parent = parent;
...
//		JKPanel pnl = new JKPanel(new FlowLayout(SwingUtility.isLeftOrientation()? FlowLayout.LEFT:FlowLayout.RIGHT));
//		pnl.setOpaque(false);
//
//		pnl.add(btnAdd);
...
//		panel.add(pnl);
//
//		JKPanel panel2 = new JKPanel(new FlowLayout(SwingUtility.isLeftOrientation()? FlowLayout.RIGHT:FlowLayout.LEFT));
...
//		model.setExtraSQLCondition(new Integer(panel.getFilterColunmIndex()), panel.getConditionString());
//		reloadData();
//	}
//
//	/**
...
//		try {
//			String newId=AddDataDialog.showAddDialog(getParentWindow(), dataPanel, autoIncrement);
//			reloadData();
//			if(newId!=null){
