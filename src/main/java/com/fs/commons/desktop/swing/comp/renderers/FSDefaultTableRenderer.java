...
public class FSDefaultTableRenderer extends DefaultTableCellRenderer {
	...
	public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected, boolean hasFocus, int row, int column) {
		...
		//the above statement is very imporant to avoid caching the last column format
		if (format == null) {
		...
		// System.out.println("value "+value+"  of class :"+(value==null?null:value.getClass().getName()));
