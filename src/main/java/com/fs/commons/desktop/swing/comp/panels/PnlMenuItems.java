...
//
//	// ///////////////////////////////////////////////////////
//	public static JKMenuItem createJKMenuItem(final MenuItem item, final MenuItemSelectionListener listener) {
//		if (item.getParentMenu().getParentModule().getApplication().isAllowedCommand(item.getPriviligeId(), item.getName())) {
//			item.init();
