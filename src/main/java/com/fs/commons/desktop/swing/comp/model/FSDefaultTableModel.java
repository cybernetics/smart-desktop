...
//
     ...
     * @see #setValueAt
     */
    public FSDefaultTableModel(int rowCount, int columnCount) {
     ...
     * @see #setValueAt
     */
    public FSDefaultTableModel(Vector columnNames, int rowCount) {
     ...
     * @see #setValueAt
     */
    public FSDefaultTableModel(Object[] columnNames, int rowCount) {
     ...
     * @see #setDataVector
     */
    public FSDefaultTableModel(Vector data, Vector columnNames) {
     ...
     * @see #setDataVector
     */
    public FSDefaultTableModel(Object[][] data, Object[] columnNames) {
        setDataVector(data, columnNames);
    }
...
//	    ((Vector)dataVector.elementAt(i)).setSize(getColumnCount());
    ...
    public Object removeRow(int row) {
        Object removed = dataVector.remove(row);
