...
public class Fader extends TimerTask {
	...
	public Fader(final JDialog jDialog) {
	...
	public void run() {
		...
		// dispose()
		if (AWTUtilities.getWindowOpacity(this.jDialog) > 0.01f) {
			AWTUtilities.setWindowOpacity(this.jDialog, AWTUtilities.getWindowOpacity(this.jDialog) - 0.01f);
		} else {
			// jDialog.dispose();
		}
	}
