...
// * @param arrayList
// */
// public DynamicTableModel(ArrayList<RowData> data, ArrayList<Column>
// columnNames) {
// this.data = data;
// columns = columnNames;
// }
...
// return index - 1;
// }
// throw new IllegalStateException("model with " + getColumnCount() + " columns
// has invalid on column getVisibleColumnRealIndex() " + col);
// }
//
// /**
// *
