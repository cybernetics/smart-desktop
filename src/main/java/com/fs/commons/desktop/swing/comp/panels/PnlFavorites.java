...
//import com.fs.commons.desktop.swing.comp.panels.PnlMenuItems.MenuItemSelectionListener;
...
//
//	// ////////////////////////////////////////////////////////////////////////
//	public PnlFavorites(Application application, FavoritePanelSelectionListener listener) {
...
//						byte[] file = GeneralUtility.readFile(new File(getIconPath(menuItem.getName())));
//						final JPanel pnlItem = SwingUtility.buildImagePanel(file, ImagePanel.SCALED);
//						final JKMenuItem btnItem = PnlMenuItems.createJKMenuItem(menuItem, new MenuItemSelectionListener() {
//
//							@Override
...
//		Hashtable<String, String> hashtable = UserPreferences.getHashtable(getKeyName());
