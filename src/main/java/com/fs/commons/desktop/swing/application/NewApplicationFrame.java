...
//
// private static final int AUTO_LOGOUT_INTERVAL =
// Integer.parseInt(System.getProperty("logout.interval","15"));
//
...
// */
// public NewApplicationFrame(Application application) throws
...
// * @throws UIOPanelCreationException
// */
// public void setApplication(Application application) throws
// UIOPanelCreationException {
...
// }
// };
// InactivityListener listener = new InactivityListener(logout,
...
// }
//
// private ApplicationPanel getApplicationPanel() throws
// UIOPanelCreationException {
...
//// System.err.println("Privlige Id : " + priviligeId + " , with name : " +
// name + " is not allowed");
//// return false;
