...
//	// }
//	// /////////////////////////////////////////////////////////////////////////
//	public DataBaseAnaylazer(ConnectionManager connectionManager) throws DaoException, SQLException {
...
//
//	// /////////////////////////////////////////////////////////////////////////
//	public ArrayList<TableMeta> getTables(String databaseName) throws SQLException, DaoException {
...
//
//	// ///////////////////////////////////////////////////////////////////////////////////////////////////////////
//	public Hashtable<String, TableMeta> getDyanmicMeta() throws SQLException, DaoException {
//		if (connectionManager == null) {
//			throw new IllegalStateException("calling getDyanmicMeta is not allowed without connectionManager");
//		}
//		return getDyanmicMeta(connectionManager.getDatabaseName());
//	}
//
//	// ///////////////////////////////////////////////////////////////////////////////////////////////////////////
//	public Hashtable<String, TableMeta> getDyanmicMeta(String databaseName) throws SQLException, DaoException {
...
//
//	// ///////////////////////////////////////////////////////////////////////////////////////////////////////////
//	public ArrayList<FieldMeta> getFields(String catalogName, String tableName) throws SQLException, DaoException {
...
//		ArrayList<ForiegnKeyFieldMeta> foriegnFields = getForiegnKeys(catalogName, tableName);
...
//	 * @throws SQLException
//	 */
//	private ArrayList<ForiegnKeyFieldMeta> getForiegnKeys(String catalogName, String tableName) throws SQLException {
...
//	 * @throws DaoException
//	 */
//	private IdFieldMeta getIdField(String catalogName, String tableName) throws SQLException, DaoException {
...
//			CachedRowSet rowSet = dao.executeQuery("select * from `" + catalogName + "`." + tableName + " limit 1");
