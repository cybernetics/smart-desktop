...
public class ConstraintPanel extends JKPanel<Object> {
	...
	private void init() {
		final JKPanel<?> pnl = new JKPanel<Object>(new GridLayout(1, 2));
		...
		final JKPanel<?> pnlFields = new JKPanel<Object>(new BorderLayout());
	...
	private void init(final TableMeta tableMeta, final Constraint constraint) {
		...
		this.fieldsModel = new DefaultListModel<String>();
